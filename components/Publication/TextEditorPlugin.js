...
const linkifyPlugin = createLinkifyPlugin({
  ...
  component(props) {
    return (
      <a
        {...props}
        className="mt-4 text-gray-600 hover:text-primary font-semibold hover:border-b-2 hover:border-primary"
      />
    )
  },
})
...
const linkPlugin = createLinkPlugin({
  ...
  theme: {
    ...
    link: 'mt-4 text-primary font-semibold hover:border-b-2 hover:border-primary  ',
  },
  placeholder: 'https://',
})
