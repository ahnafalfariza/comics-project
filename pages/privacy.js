      ...
      <div className="md:max-w-4xl m-auto py-12 p-4">
        ...
        <ul className={privacyStyles.ul}>
          ...
          <li className={privacyStyles.li}>
            ...
            "Us" or "Our" in this Agreement) refers to Paras Marketplace.
          </li>
          <li className={privacyStyles.li}>
          ...
          <li className={privacyStyles.li}>
            <strong>Website</strong> refers to Paras Marketplace, accessible
            from{' '}
            <a
              href="https://paras.id/"
              target="_blank"
        ...
        <ul className={privacyStyles.ul}>
          <li className={privacyStyles.li}>
            ...
            <a
              ...
              rel="noopener noreferrer"
            >
              https://twitter.com/ParasComic
            </a>
          </li>
          <li className={privacyStyles.li}>
            On Instagram:{' '}
            <a
              href="https://www.instagram.com/paras.comic/"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://www.instagram.com/paras.comic/
            </a>
          </li>
          <li className={privacyStyles.li}>
            On Telegram:{' '}
