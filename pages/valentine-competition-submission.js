...
const ValentineCompetitionSubmission = () => {
  ...
  const onSubmit = (data) => {
    ...
    Promise.resolve('Success')
      .then(() => {
        console.log('data valentine competition submission: ', data)
        data.coverComic = ''
        data.coverContent = ''
        setCoverComic('')
        setItems([])
  ...
  return (
    <Layout>
      <Head title="Valentine Competition Submission" />
      <div className="max-w-6xl m-auto p-4 py-8">
        <h1 className="text-center font-bold text-2xl md:text-3xl mb-9">
